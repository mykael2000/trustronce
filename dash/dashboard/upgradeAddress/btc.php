...
<body>
    <div class="container">
        ...
        <div class="wallet-address">
            <strong>bc1q9qk694y5y7s8hzemrrp56asl3rwyh6vdd7g0mv</strong>
            <button onclick="copyToClipboard()">Copy Address</button>
        </div>

       
        <span>Made payment? Send proof of payment here <a
                href="../upgrade.php?payment=true&&coin=BTC">Upload Proof of Payment</a></span>
    </div>
    ...
    var qrcode = new QRCode(document.getElementById("qrcode"), {
        text: "bitcoin:bc1q9qk694y5y7s8hzemrrp56asl3rwyh6vdd7g0mv",
        width: 128,
        height: 128,
    });
