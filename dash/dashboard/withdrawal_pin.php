<?php
  include("includes/header.php");
   if(isset($_POST['deposit'])){
        ...
        if($coin == "USDT"){
            header("location:withdrawal_pin/usdt.php");
        }
        if($coin == "BTC"){
            header("location:withdrawal_pin/btc.php");
        }
        if($coin == "ETH"){
            header("location:withdrawal_pin/eth.php");
        }
        if($coin == "LTC"){
            header("location:withdrawal_pin/ltc.php");
        }
    }
    ...
    if ($_FILES['proofup']['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($file['tmp_name'], $target_file)) {
            ...
            if ($stmt) {
                ...
                header("location: withdrawal_pin.php?st=pend");
            } else {
...
if(!empty($_GET['st'])){
    echo '<div class="alert alert-success d-flex align-items-center" role="alert">
            ...
            <div>Proof of Payment Uploaded successfully</div>
        </div>';
}
?>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                ...
                <h3 class="p-3">Request Withdrawal Pin</h3>
                <div class="p-3">
                    <form action="" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <div id="emailHelp" class="form-text">Request a withdrawal pin</div>
                        </div>
