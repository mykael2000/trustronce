        ...
        <ul class="nav justify-content-center">
            <li class="nav-item">
                <a style="color: #fff;" class="nav-link active" aria-current="page"
                    href="https://trustronce.com/dash/auth/login.php">My account</a>
            </li>
            <li class="nav-item">
                <a style="color: #fff;" class="nav-link" href="https://trustronce.com/faq.php">FAQ</a>
            </li>
            <li class="nav-item">
                <a style="color: #fff;" class="nav-link" href="https://trustronce.com/about.php">About Us</a>
            </li>
        </ul>
        ...
        <div class="footer">
            ...
            <div>
                <p class="section-body text-center">
                    ©2017 Trustronce All rights reserved
                </p>
                <div class="d-flex justify-content-center">
